...
cp -r productivity/tui-widgets ~/.hermes/skills/productivity/tui-widgets/

# Option B: Install directly from this repository's raw SKILL.md URL
<agent-cli> skills install https://raw.githubusercontent.com/iizcm/tui-widgets-skill/main/SKILL.md

# Option C: Clone this entire repo into your skills directory
git clone https://github.com/iizcm/tui-widgets-skill.git ~/.hermes/skills/productivity/tui-widgets/
```
...
```text
skill_view(name="productivity/tui-widgets")
```
...
```text
Use the tui widgets skill to <describe your specific task here>
```
...
```text
Gunakan skill tui widgets untuk <deskripsikan tugas spesifik Anda di sini>
```
